...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       System.out.println("CalculateBMI = " +work03.MyUtil.calculateBMI(66,10));
       System.out.println("Average = " +work03.MyUtil.avernage(10, 20, 40));
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
      ...
      bankaccount2.deposit(1700);

      bankaccount1.withdraw(100);
      bankaccount2.withdraw(1500);
      
      bankaccount1.transfer(1999,bankaccount2);
